...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_CloseDoorDelay;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorDelay_MetaData[] = {
		{ "Category", "OpenDoor" },
		{ "ModuleRelativePath", "Public/OpenDoor.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorDelay = { "CloseDoorDelay", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOpenDoor, CloseDoorDelay), METADATA_PARAMS(Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorDelay_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorSpeed_MetaData[] = {
		{ "Category", "OpenDoor" },
		{ "ModuleRelativePath", "Public/OpenDoor.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorSpeed = { "CloseDoorSpeed", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOpenDoor, CloseDoorSpeed), METADATA_PARAMS(Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorSpeed_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenDoorSpeed_MetaData[] = {
		{ "Category", "OpenDoor" },
		{ "ModuleRelativePath", "Public/OpenDoor.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenDoorSpeed = { "OpenDoorSpeed", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOpenDoor, OpenDoorSpeed), METADATA_PARAMS(Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenDoorSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenDoorSpeed_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOpenDoor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorDelay,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOpenDoor_Statics::NewProp_CloseDoorSpeed,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOpenDoor_Statics::NewProp_OpenDoorSpeed,
	...
	IMPLEMENT_CLASS(UOpenDoor, 2943171307);
