...
#include "BuildingEscape2/BuildingEscape2GameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	struct Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_AGameModeBase,
		(UObject* (*)())Z_Construct_UPackage__Script_BuildingEscape2,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ABuildingEscape2GameModeBase>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_ABuildingEscape2GameModeBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ABuildingEscape2GameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ABuildingEscape2GameModeBase, 3939006186);
	template<> BUILDINGESCAPE2_API UClass* StaticClass<ABuildingEscape2GameModeBase>()
	{
		return ABuildingEscape2GameModeBase::StaticClass();
	}
